...
#https://pythonguides.com/matplotlib-change-background-color/
      ...
      #https://stackoverflow.com/questions/9627686/plotting-dates-on-the-x-axis-with-pythons-matplotlib
        ...
        #plt.gca().xaxis.set_major_locator(mdates.DayLocator()) #plt.gca().xaxis.set_major_formatter(mdates.DateFormatter('%m/%d/%y'))
 ...
 #https://stackoverflow.com/questions/25689238/show-origin-axis-x-y-in-matplotlib-plot
        ...
        #y =  [100, 2, 3, 4, 5, 4, 3, 0.0, 5, 4, 5, -4, 5, 5, -100, 5, 1, 14, 4, 14, 4, 4]  #Getvalue() #[-3,-2,-4,0,1]
        #x = ['25/03/22', '25/03/22', '25/03/22', '25/03/22', '25/03/22', '25/03/22', '25/03/22', '25/03/22', '25/03/22', '25/03/22', '26/03/22', '26/03/22', '26/03/22', '26/03/22', '26/03/22', '26/03/22', '26/03/22', '26/03/22', '26/03/22', '26/04/22', '27/04/22', '27/04/22']  #Getdate() # ['25/05/22','25/05/22', '27/05/22', '28/05/22', '29/05/22']  
